<div class="space-y-6">
    ...
    <x-ts-card>
        <form class="sm:grid sm:grid-cols-4 space-y-4 sm:space-y-0 gap-4">
            ...
            <div class="col-span-2">
                <x-ts-input wire:model="data.child_phone" label="WhatsApp da criança" x-mask="(99) 99999-9999" />
            </div>
            <div class="col-span-2">
                <x-ts-input wire:model="data.parent_phone" label="WhatsApp do responsável" x-mask="(99) 99999-9999" />
            </div>
            <div class="col-span-2">
