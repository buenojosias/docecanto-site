<x-ts-modal title="Lançar mensalidade" size="sm" wire>
    <form wire:submit="addMensality" id="mensality-form" class="space-y-4">
        ...
        <x-ts-select.native label="Mês de referência" wire:model="month" :options="$months" select="label:label|value:value" />
    ...
    <x-slot:footer>
        <x-ts-button text="Salvar" type="submit" form="mensality-form" loading="addMensality" />
    </x-slot>
</x-ts-modal>
