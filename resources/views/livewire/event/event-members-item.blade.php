<div class="flex items-center">
    ...
    @endif
    @if ($showFormModal)
        <x-ts-modal wire="showFormModal" id="response-modal" :title="$action === 'create' ? 'Adicionar resposta' : 'Alterar respostas'" size="sm">
            ...
            <x-slot:footer>
                ...
                <x-ts-button sm flat text="Cancelar" x-on:click="$tsui.close.modal('response-modal')" />
            </x-slot:footer>
        </x-ts-modal>
    @endif
</div>
