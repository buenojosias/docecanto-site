        ...
        <div class="card w-full">
            <form wire:submit.prevent="submit">
                ...
                <div class="card-body display">
                    @if (!$validAudio)
                        <x-input type="file" wire:model="audio" label="Arquivo" />
                            ...
                            <div class="flex justify-center items-center w-full">
                                <label for="audio"
                                    ...
                                    <div class="flex flex-col justify-center items-center pt-5 pb-6">
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400">MP3 (máx. 10mb)</p>
                                    </div>
                ...
                {{-- <div class="card-body display">
                <x-input type="file" wire:model.defer="file" accept="audio/mp3" label="Arquivo" />
            </div> --}}
